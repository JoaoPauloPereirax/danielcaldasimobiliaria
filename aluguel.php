...
<head>
    ...
    <title>Aluguel de Imóveis | Daniel Caldas da Silva</title>
    <!-- Bootstrap CSS -->
...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="#"><i class="fas fa-key me-1"></i> Aluguel</a>
                    </li>
                    <li class="nav-item">
    ...
    <section class="hero-section">
        <div class="container text-center">
            <h1 class="display-4 fw-bold mb-4">Encontre o imóvel perfeito para alugar</h1>
            <p class="lead mb-5">Opções residenciais e comerciais nos melhores bairros</p>
        </div>
    </section>

    <!-- Seção de Filtros -->
    <section class="rental-properties">
        <div class="container">
            <div class="filter-section">
                <h4 class="mb-4"><i class="fas fa-filter text-primary me-2"></i>Filtrar Imóveis</h4>
                <form>
                    <div class="row g-3">
                        <div class="col-md-3">
            ...
            <div class="section-title text-center mb-5">
                <h2 class="fw-bold">Imóveis para Aluguel</h2>
                <p class="text-muted">Confira nossas melhores opções disponíveis</p>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="property-card">
                        <img src="https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60" class="property-img w-100" alt="Apartamento para aluguel">
                        <div class="card-body">
                            <span class="badge bg-success mb-3">Aluguel</span>
                            <h5 class="card-title">Apartamento 2 quartos</h5>
                            <p class="card-text property-type"><i class="fas fa-map-marker-alt text-primary"></i> Centro, São Paulo</p>
                            <p class="rent-price">R$ 2.200/mês</p>
                            ...
                            <div class="d-grid gap-2">
                                <a href="#" class="btn btn-rent"><i class="fas fa-key me-1"></i> Alugar agora</a>
                ...
                <div class="col-md-4">
                    <div class="property-card">
                        ...
                        <div class="card-body">
                            ...
                            <p class="rent-price">R$ 4.500/mês</p>
                ...
                <div class="col-md-4">
                    <div class="property-card">
                        <img src="https://images.unsplash.com/photo-1512917774080-9991f1c4c750?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60" class="property-img w-100" alt="Casa para aluguel">
                        <div class="card-body">
                            <span class="badge bg-success mb-3">Aluguel</span>
                            <h5 class="card-title">Casa 4 quartos</h5>
                            <p class="card-text property-type"><i class="fas fa-map-marker-alt text-primary"></i> Jardim Paulista, São Paulo</p>
                            <p class="rent-price">R$ 6.800/mês</p>
                ...
                <div class="col-md-4">
                    <div class="property-card">
                        <img src="https://images.unsplash.com/photo-1554469384-e58fac16e23a?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60" class="property-img w-100" alt="Apartamento compacto">
                        <div class="card-body">
                            <span class="badge bg-success mb-3">Aluguel</span>
                            <h5 class="card-title">Kitnet 1 quarto</h5>
                            <p class="card-text property-type"><i class="fas fa-map-marker-alt text-primary"></i> Vila Mariana, São Paulo</p>
                            <p class="rent-price">R$ 1.500/mês</p>
                            ...
                            <div class="property-features">
                                ...
                                <div class="property-feature">
                                    <i class="fas fa-bed"></i> 1 Quarto
                                </div>
                                <div class="property-feature">
                                    <i class="fas fa-bath"></i> 1 Banheiro
                                </div>
                                <div class="property-feature">
                                    <i class="fas fa-car"></i> 0 Vagas
                                </div>
                            </div>
                ...
                <div class="col-md-4">
                    <div class="property-card">
                        <img src="https://images.unsplash.com/photo-1493809842364-78817add7ffb?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60" class="property-img w-100" alt="Apartamento de luxo">
                        <div class="card-body">
                            <span class="badge bg-success mb-3">Aluguel</span>
                            <h5 class="card-title">Apartamento de Luxo</h5>
                            <p class="card-text property-type"><i class="fas fa-map-marker-alt text-primary"></i> Itaim Bibi, São Paulo</p>
                            <p class="rent-price">R$ 8.200/mês</p>
                ...
                <div class="col-md-4">
                    <div class="property-card">
                        <img src="https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60" class="property-img w-100" alt="Casa condomínio">
                        <div class="card-body">
                            <span class="badge bg-success mb-3">Aluguel</span>
                            <h5 class="card-title">Casa em Condomínio</h5>
                            <p class="card-text property-type"><i class="fas fa-map-marker-alt text-primary"></i> Morumbi, São Paulo</p>
                            <p class="rent-price">R$ 7.500/mês</p>
