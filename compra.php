...
<head>
    ...
    <title>Compra de Imóveis | Daniel Caldas da Silva</title>
    <!-- Bootstrap CSS -->
...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="#"><i class="fas fa-dollar-sign me-1"></i> Compra de Imóvel</a>
                    </li>
    ...
    <section class="hero-section">
        <div class="container text-center">
            <h1 class="display-4 fw-bold mb-4">Encontre seu imóvel dos sonhos</h1>
            <p class="lead mb-5">As melhores opções para compra em São Paulo e região</p>
        </div>
    </section>

    <!-- Seção de Filtros -->
    <section class="sale-properties">
        <div class="container">
            ...
            <div class="section-title text-center mb-5">
                <h2 class="fw-bold">Imóveis à Venda</h2>
                <p class="text-muted">Confira nossas melhores oportunidades</p>
            </div>
            ...
            <div class="row">
                    ...
                    <div class="property-card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-grid gap-2">
                                <a href="#" class="btn btn-buy"><i class="fas fa-hand-holding-usd me-1"></i> Tenho interesse</a>
                ...
                <div class="col-md-4">
                    <div class="property-card">
                        <img src="https://images.unsplash.com/photo-1600585154340-be6161a56a0c?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60" class="property-img w-100" alt="Casa condomínio fechado">
                        <div class="card-body">
                            <span class="badge bg-primary mb-3">Venda</span>
                            <h5 class="card-title">Casa em Condomínio</h5>
                            <p class="card-text property-type"><i class="fas fa-map-marker-alt text-primary"></i> Alphaville, Barueri</p>
                            <p class="property-price">R$ 3.750.000</p>
                            
                            <div class="property-features">
                                <div class="property-feature">
                                    <i class="fas fa-ruler-combined"></i> 350 m²
                                </div>
                                <div class="property-feature">
                                    <i class="fas fa-bed"></i> 5 Quartos
                                </div>
                                <div class="property-feature">
                                    <i class="fas fa-bath"></i> 4 Banheiros
                                </div>
                ...
                <div class="col-md-4">
                    <div class="property-card">
                        ...
                        <div class="card-body">
                            ...
                            <p class="property-price">R$ 650.000</p>
                ...
                <div class="col-md-4">
                    <div class="property-card">
                        <img src="https://images.unsplash.com/photo-1605146769289-440113cc3d00?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60" class="property-img w-100" alt="Cobertura duplex">
                        <div class="card-body">
                            <span class="badge bg-primary mb-3">Venda</span>
                            ...
                            <div class="property-features">
                                <div class="property-feature">
                                    <i class="fas fa-ruler-combined"></i> 280 m²
                                </div>
                                <div class="property-feature">
                                    <i class="fas fa-bed"></i> 3 Quartos
                                </div>
